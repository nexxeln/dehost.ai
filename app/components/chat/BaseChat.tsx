                ...
                >
                  <div
                    className={classNames(
                      'shadow-[0_0_15px_rgba(138,79,255,0.2)] border border-[#D8BFD8] bg-bolt-elements-prompt-background backdrop-filter backdrop-blur-[8px] rounded-lg overflow-hidden',
                    )}
                  >
                    <textarea
                      ref={textareaRef}
                      ...
                      placeholder="Create a simple snake game using HTML and CSS..."
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
